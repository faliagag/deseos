<?php
// public/create_giftlist.php - Versión corregida
...
// PROTECCIÓN DE ACCESO - Reemplaza la línea problemática de Auth.php
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <span class="nav-link">Hola, <?php echo htmlspecialchars($user['name'] ?? 'Usuario'); ?></span>
                    </li>
                    <li class="nav-item">
